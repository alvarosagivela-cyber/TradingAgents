...
class TradingAgentsGraph:
    ...
    def _log_state(self, trade_date, final_state):
        ...
        self.log_states_dict[str(trade_date)] = {
            ...
            "conservative_verdict": final_state.get("conservative_verdict"),
            "balanced_verdict": final_state.get("balanced_verdict"),
            "aggressive_verdict": final_state.get("aggressive_verdict"),
